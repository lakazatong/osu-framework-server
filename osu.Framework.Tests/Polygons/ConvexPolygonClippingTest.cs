...
namespace osu.Framework.Tests.Polygons
{
    ...
    public class ConvexPolygonClippingTest
    {
        ...
        private static object[] externalTestCases =>
            new object[]
            {
                // Non-rotated
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { up_2, up_3, up_3 + right_1, up_2 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { right_2, right_2 + up_1, right_3 + up_1, right_3 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { down_1, down_1 + right_1, down_2 + right_1, down_2 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { left_2, left_2 + up_1, left_1 + up_1, left_1 },
                },
                // Rotated
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { up_1 + right_2, up_2 + right_1, up_3 + right_2, up_2 + right_3 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { up_1 + right_2, down_1 + right_3, down_2 + right_2, down_1 + right_1 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { down_1 + right_1, down_2 + right_2, down_3 + right_1, down_2 },
                },
                new object[]
                {
                    new[] { origin, up_1, up_1 + right_1, right_1 },
                    new[] { left_1 + up_1, down_2, down_3 + left_2, left_2 },
                },
            };
        ...
        private static object[] subjectFullyContainedTestCases =>
            new object[]
            {
                // Same polygon
                new object[]
                ...
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { down_2, left_2, up_2, right_2 },
                },
                // Corners
                new object[]
                ...
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { up_1, up_2, up_2 + right_1, up_1 + right_1 },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                ...
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { right_1, up_1 + right_1, up_1 + right_2, right_2 },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { down_2, down_1, right_1, right_2 },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { left_2, left_1, down_1, down_2 },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { left_2, up_2, up_1, left_1 },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { up_2, right_2, right_1, up_1 },
                },
                // Padded
                new object[]
                {
                    ...
                    new[]
                    {
                        right_1 * 0.5f + up_1 * 0.5f,
                        up_2 * 0.75f,
                        up_2 * 0.75f + right_2 * 0.75f,
                        right_2 * 0.75f,
                    },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { down_1, left_1, up_1, right_1 },
                },
                // Rotated
                new object[]
                {
                ...
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { up_1, up_2 * 0.75f, up_2 + right_1 * 0.5f, up_2 + right_1 },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { right_1, up_1 + right_2, up_1 * 0.5f + right_2, right_2 * 0.75f },
                },
                new object[]
                {
                    new[] { down_2, left_2, up_2, right_2 },
                    new[] { left_1 + up_1, up_1 + right_1, down_1 + right_1, left_1 + down_1 },
                },
            };
        ...
        public void TestSubjectFullyContained(Vector2[] clipVertices, Vector2[] subjectVertices)
        {
            ...
            assertPolygonEquals(
                subjectPolygon,
                new SimpleConvexPolygon(clip(clipPolygon, subjectPolygon).ToArray()),
                false
            );
        ...
        private static object[] generalClippingTestCases =>
            new object[]
            {
                new object[]
                {
                ...
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { left_1, up_1, right_1, down_1 },
                    new[] { origin, up_1, right_1 },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                ...
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { up_2 + right_1, up_3 + right_2, up_2 + right_3, up_1 + right_2 },
                    new[] { up_2 + right_1, up_2 + right_2, up_1 + right_2 },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { left_1 + up_1, up_3 + right_1, up_1 + right_1, origin },
                    new[] { up_2, up_2 + right_1, up_1 + right_1, origin },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { left_1 + up_1, up_1 + right_3, down_1 + right_3, left_1 + down_1 },
                    new[] { up_1, up_1 + right_2, right_2, origin },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { down_1 + left_1, up_3 + left_1, up_3 + right_1, down_1 + right_1 },
                    new[] { origin, up_2, up_2 + right_1, right_1 },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { down_1, up_1 + right_1, down_1 + right_2, down_2 + right_1 },
                    new[] { right_1 * 0.5f, up_1 + right_1, right_2 * 0.75f },
                },
                new object[]
                {
                    new[] { origin, up_2, up_2 + right_2, right_2 },
                    new[] { origin, up_3 + right_3, right_2 },
                    new[] { origin, up_2 + right_2, right_2 },
                },
                new object[]
                {
                    new[] { up_2, right_2, down_2, left_2 },
                    new[] { left_1 + down_2, left_2 + down_2, up_2 + left_2, up_2 + left_1 },
                    new[] { up_1 + left_1, down_1 + left_1, left_2 },
                },
                new object[]
                {
                    new[] { up_2, right_2, down_2, left_2 },
                    new[] { origin, down_2 + left_2, up_2 + left_2 },
                    new[] { origin, down_1 + left_1, left_2, up_1 + left_1 },
                },
                new object[]
                {
                    new[] { up_2, right_2, down_2, left_2 },
                    new[] { origin, left_3, up_3 },
                    new[] { origin, left_2, up_2 },
                },
                new object[]
                {
                    new[] { up_2, right_2, down_2, left_2 },
                    new[] { origin, left_3, up_3, right_3 },
                    new[] { origin, left_2, up_2, right_2 },
                },
                new object[]
                {
                ...
                new object[]
                {
                    ...
                    new[]
                    {
                        up_1 * 0.5f + left_1 * 0.5f,
                        up_1,
                        up_1 * 0.5f + right_1 * 0.5f,
                        right_1 * 0.5f,
                        left_1 * 0.5f,
                    },
                },
        ...
        public void TestGeneralClipping(
            Vector2[] clipVertices,
            Vector2[] subjectVertices,
            Vector2[] resultingVertices
        )
        {
            var clipPolygon = new SimpleConvexPolygon(clipVertices);
            var subjectPolygon = new SimpleConvexPolygon(subjectVertices);
        ...
        {
            assertPolygonEquals(
                new SimpleConvexPolygon(
                    new[] { Vector2.Zero, new Vector2(0, 1), new Vector2(1, 0) }
                ),
                new SimpleConvexPolygon(
                    clip(
                            new Quad(
        ...
        public void TestLineClipping()
        {
            assertPolygonEquals(
                ...
                new SimpleConvexPolygon(
                    clip(new Quad(25, 25, 0, 10), new Quad(0, 0, 100, 100)).ToArray()
                ),
                false
            );
            ...
            assertPolygonEquals(
                new SimpleConvexPolygon(Array.Empty<Vector2>()),
                new SimpleConvexPolygon(
                    clip(new Quad(25, 25, 10, 0), new Quad(0, 0, 100, 100)).ToArray()
                ),
                false
            );
        }
        ...
        public void TestPointClipping()
        {
            assertPolygonEquals(
                new SimpleConvexPolygon(Array.Empty<Vector2>()),
                new SimpleConvexPolygon(
                    clip(new Quad(25, 25, 0, 0), new Quad(0, 0, 100, 100)).ToArray()
                ),
                false
            );
        }
        ...
        public void TestEmptyClip()
        {
            ...
            assertPolygonEquals(
                new SimpleConvexPolygon(Array.Empty<Vector2>()),
                new SimpleConvexPolygon(
                    clip(new SimpleConvexPolygon(Array.Empty<Vector2>()), quad).ToArray()
                ),
                false
            );
        }
        ...
        public void TestEmptySubject()
        {
            ...
            assertPolygonEquals(
                new SimpleConvexPolygon(Array.Empty<Vector2>()),
                new SimpleConvexPolygon(
                    clip(quad, new SimpleConvexPolygon(Array.Empty<Vector2>())).ToArray()
                ),
                false
            );
        }

        private static object[] fuzzedEdgeCases =>
            new object[]
            {
                new object[]
                {
                ...
                new object[]
                {
                    new[]
                    {
                        new Vector2(2, float.MinValue),
                        new Vector2(float.MaxValue, 0.5f),
                        new Vector2(float.MaxValue, float.NegativeInfinity),
                        new Vector2(1, float.MaxValue),
                    },
                    new[]
                    {
                        new Vector2(0, 1),
                        new Vector2(0, float.NegativeInfinity),
                        new Vector2(float.Epsilon, 1),
                        new Vector2(1, 0.5f),
                    },
                },
                new object[]
                {
                    new[]
                    {
                        new Vector2(float.Epsilon, 0.5f),
                        new Vector2(float.Epsilon, 100),
                        new Vector2(float.MaxValue, float.NegativeInfinity),
                        new Vector2(1, float.MaxValue),
                    },
                    new[]
        ...
        private Span<Vector2> clip(
            SimpleConvexPolygon clipPolygon,
            SimpleConvexPolygon subjectPolygon
        ) =>
            new ConvexPolygonClipper<SimpleConvexPolygon, SimpleConvexPolygon>(
                clipPolygon,
                subjectPolygon
            ).Clip();
        ...
        private void assertPolygonEquals(IPolygon expected, IPolygon actual, bool reverse) =>
            Assert.That(
                Vector2Extensions.GetOrientation(actual.GetVertices()),
                reverse
