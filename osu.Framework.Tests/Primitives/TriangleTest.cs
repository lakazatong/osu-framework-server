            ...
            public static IEnumerable TestCases
            {
                get
                {
                    ...
                    yield return new TestCaseData(
                        new Triangle(Vector2.Zero, Vector2.Zero, Vector2.Zero)
                    ).Returns(0);

                    // Angled
                    yield return new TestCaseData(
                        new Triangle(Vector2.Zero, new Vector2(10, 0), new Vector2(10))
                    ).Returns(50);
                    yield return new TestCaseData(
                        new Triangle(Vector2.Zero, new Vector2(0, 10), new Vector2(10))
                    ).Returns(50);
                    yield return new TestCaseData(
                        new Triangle(Vector2.Zero, new Vector2(10, -10), new Vector2(10))
                    ).Returns(100);
                    yield return new TestCaseData(
                        new Triangle(Vector2.Zero, new Vector2(10, -10), new Vector2(10))
                    ).Returns(100);
