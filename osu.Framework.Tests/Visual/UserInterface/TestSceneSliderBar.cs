...
namespace osu.Framework.Tests.Visual.UserInterface
{
    public partial class TestSceneSliderBar : ManualInputManagerTestScene
    {
        ...
        {
            sliderBarValue = new BindableDouble { MinValue = -10, MaxValue = 10 };
            ...
            Add(
                new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        new SpriteText { Text = "BasicSliderBar:" },
                        ...
                        new SpriteText { Text = "w/ RangePadding:" },
                        ...
                        new SpriteText { Text = "w/ TransferValueOnCommit:" },
        ...
        public void TestVerticalDragHasNoEffect()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.75f, 0.0f))
                    );
                }
            );
            AddStep(
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.75f, 1f))
                    );
                }
            );
            AddStep(
        ...
        public void TestDragOutReleaseInHasNoEffect()
        {
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.75f, 1.5f))
                    );
                }
            );
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.25f, 1.5f))
                    );
                }
            );
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.25f, 0.5f))
                    );
                }
            );
            AddStep(
        ...
        public void TestKeyboardInput()
        {
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(2f, 0.5f))
                    );
                }
            );
        ...
        public void TestAdjustmentPrecision(bool disabled)
        {
            ...
            AddStep(
                "Click at 75% mark, holding shift",
                () =>
                {
                    InputManager.PressKey(Key.LShift);
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.75f, 0.5f))
                    );
                    InputManager.Click(MouseButton.Left);
        ...
        public void TestTransferValueOnCommit(bool disabled)
        {
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBar.ToScreenSpace(sliderBar.DrawSize * new Vector2(0.8f, 0.5f))
                    );
                    InputManager.Click(MouseButton.Left);
                }
            );
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        transferOnCommitSliderBar.ToScreenSpace(
                            transferOnCommitSliderBar.DrawSize * new Vector2(0.75f, 0.5f)
                        )
                    );
                }
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        transferOnCommitSliderBar.ToScreenSpace(
                            transferOnCommitSliderBar.DrawSize * new Vector2(0.25f, 0.5f)
                        )
                    );
                }
            );
        ...
        public void TestAbsoluteDrag()
        {
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.1f, 0.5f)
                        )
                    );
                }
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.4f, 1f)
                        )
                    );
                }
            );
        ...
        public void TestRelativeDrag()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.6f, 0.5f)
                        )
                    );
                }
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.75f, 1f)
                        )
                    );
                }
            );
        ...
        public void TestClickSecondButtonWhileRelativeDragging()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.25f, 0.5f)
                        )
                    );
                }
            );
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.3f, 0.5f)
                        )
                    );
                }
            );
        ...
        public void TestClickSecondButtonWhileAbsoluteDragging()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        sliderBarWithNub.ToScreenSpace(
                            sliderBarWithNub.DrawSize * new Vector2(0.8f, 0.5f)
                        )
                    );
                }
            );
        ...
        private void checkValue(int expected) =>
            AddAssert(
                $"Value == {expected}",
                () => sliderBarValue.Value,
                () => Is.EqualTo(expected).Within(Precision.FLOAT_EPSILON)
            );
