    ...
    public partial class TestSceneFrontToBackBox : FrameworkTestScene
    {
        ...
        public void TearDownSteps()
        {
            AddToggleStep(
                ...
                val => debugConfig.SetValue(DebugSetting.BypassFrontToBackPass, val)
            );
        }
                ...
                () =>
                {
                    Children = new Drawable[]
                    {
                        ...
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                new Box { RelativeSizeAxes = Axes.Both, Colour = Color4.Green },
                                new Container
                                {
                                    Anchor = Anchor.Centre,
                                    Origin = Anchor.Centre,
        ...
        private void createBlendedBox(Action<Box> setupAction = null) =>
            AddStep(
                "create box",
                () =>
                {
