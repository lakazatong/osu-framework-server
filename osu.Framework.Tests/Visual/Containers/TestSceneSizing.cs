...
namespace osu.Framework.Tests.Visual.Containers
{
    ...
    public partial class TestSceneSizing : FrameworkTestScene
    {
        ...
        public void TestBypassAutoSizeAxes()
        {
            ...
            AddAssert(
                $"height = {autosize_height}",
                () => Precision.AlmostEquals(autosize_height, autoSizeContainer.DrawHeight)
            );
        ...
        {
            Child = testContainer = new Container { RelativeSizeAxes = Axes.Both };
            addCrosshair();
            ...
            switch (testType)
            {
                ...
                case 7:
                    ...
                    shrinkContainer
                        .ScaleTo(new Vector2(1.5f, 1), 1000)
                        .Then()
                        .ScaleTo(Vector2.One, 1000)
                        .Loop();
                    break;
                ...
                case 12:
                {
                    ...
                    sizedBox
                        .ScaleTo(new Vector2(2), 1000, Easing.Out)
                        .Then()
                        .ScaleTo(Vector2.One, 1000, Easing.In)
                        .Loop();
                    break;
                }
        ...
        private partial class NegativeSizingContainer : Container
        {
            ...
            protected override void LoadComplete()
            {
                ...
                if (useScale)
                    box.ScaleTo(new Vector2(-1), 3000, Easing.InSine)
                        .Then()
                        .ScaleTo(new Vector2(1), 3000, Easing.InSine)
                        .Loop();
                else
                    box.ResizeTo(new Vector2(-size), 3000, Easing.InSine)
                        .Then()
                        .ResizeTo(new Vector2(size), 3000, Easing.InSine)
                        .Loop();
            }
    ...
    internal partial class InfofulBoxAutoSize : Container
    {
        ...
        public InfofulBoxAutoSize()
        {
            ...
            {
                new Box { RelativeSizeAxes = Axes.Both, Depth = float.MaxValue },
    ...
    internal partial class InfofulBox : Container
    {
        ...
        public InfofulBox()
        {
            Add(new Box { RelativeSizeAxes = Axes.Both, Depth = float.MaxValue });
        }
    }
}
