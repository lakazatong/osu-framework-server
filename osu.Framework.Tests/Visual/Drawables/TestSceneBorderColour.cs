...
namespace osu.Framework.Tests.Visual.Drawables
{
    public partial class TestSceneBorderColour : FrameworkTestScene
    {
        ...
        [Test]
        public void TestVerticalGradientBorder() =>
            createBorderTest(
                Colour4.Green,
                ColourInfo.GradientVertical(Colour4.Black, Colour4.White)
            );

        [Test]
        public void TestHorizontalGradientBorder() =>
            createBorderTest(
        ...
        [Test]
        public void TestAllFourCorners() =>
            createBorderTest(
                Colour4.Aquamarine,
                new ColourInfo
                {
                ...
                () =>
                    Child = container =
                        new Container
                        {
                            ...
                            Child = box =
                                new Box { RelativeSizeAxes = Axes.Both, Colour = fillColour },
                        }
            );

            AddToggleStep(
                "switch fill to border colour",
                useBorderColour => box.Colour = useBorderColour ? borderColour : fillColour
            );
