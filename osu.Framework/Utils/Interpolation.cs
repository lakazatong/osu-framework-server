...
namespace osu.Framework.Utils
{
    public static class Interpolation
    {
        ...
        public static double Damp(double start, double final, double @base, double exponent)
        {
            if (@base < 0 || @base > 1)
                throw new ArgumentOutOfRangeException(
                    nameof(@base),
                    $"{nameof(@base)} has to lie in [0,1], but is {@base}."
                );
        ...
        public static double DampContinuously(
            double current,
            double target,
            double halfTime,
            double elapsedTime
        ...
        /// <param name="time">The x coordinate to calculate the basis polynomial for.</param>
        public static double BarycentricLagrange(
        ...
        )
        {
            ...
            if (points.Length != weights.Length)
                throw new ArgumentException(
                    $"{nameof(points)} must contain exactly as many items as {nameof(weights)}"
                );
        ...
        public static ColourInfo ValueAt(
            double time,
            ColourInfo startColour,
        ...
        public static EdgeEffectParameters ValueAt(
            double time,
            EdgeEffectParameters startParams,
            EdgeEffectParameters endParams,
            double startTime,
            double endTime,
            Easing easing = Easing.None
        ) =>
        ...
        public static SRGBColour ValueAt(
            double time,
            SRGBColour startColour,
            SRGBColour endColour,
            double startTime,
            double endTime,
            Easing easing = Easing.None
        ) =>
        ...
        public static RectangleF ValueAt(
            double time,
            RectangleF val1,
            RectangleF val2,
            double startTime,
        ...
        public static TValue ValueAt<TValue>(
            double time,
            TValue startValue,
            TValue endValue,
            double startTime,
        ...
        public static TValue ValueAt<TValue, TEasing>(
            double time,
            TValue startValue,
            TValue endValue,
            double startTime,
            ...
            where TEasing : IEasingFunction
        {
            ...
            return GenericInterpolation<TValue, TEasing>.FUNCTION(
                time,
                startValue,
                endValue,
                startTime,
        ...
        public static double ApplyEasing<TEasing>(in TEasing easing, double time)
            where TEasing : IEasingFunction => easing.ApplyEasing(time);
            ...
            where TEasing : IEasingFunction
        {
            ...
            )
            {
                ...
                return new ColourInfo
                {
                    TopLeft = ValueAt(
                        time,
                        (Color4)startColour.TopLeft,
                        (Color4)endColour.TopLeft,
                        startTime,
                        endTime,
                        easing
                    ),
                    BottomLeft = ValueAt(
                        time,
                        (Color4)startColour.BottomLeft,
                        (Color4)endColour.BottomLeft,
                        startTime,
                        endTime,
                        easing
                    ),
                    TopRight = ValueAt(
                        time,
                        (Color4)startColour.TopRight,
                        (Color4)endColour.TopRight,
                        startTime,
                        endTime,
                        easing
                    ),
                    BottomRight = ValueAt(
                        time,
                        (Color4)startColour.BottomRight,
                        (Color4)endColour.BottomRight,
                        startTime,
                        endTime,
                        easing
                    ),
            ...
            )
            {
                ...
                return new Color4(
                    ...
                    startLinear.A + t * (endLinear.A - startLinear.A)
                ).ToSRGB();
            }
            ...
            where TEasing : IEasingFunction
        {
            ...
            static GenericInterpolation()
            {
                if (typeof(TValue) == typeof(ColourInfo))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<ColourInfo, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(EdgeEffectParameters))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<EdgeEffectParameters, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(SRGBColour))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<SRGBColour, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(Color4))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<Color4, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(Colour4))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<Colour4, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(byte))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<byte, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(sbyte))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<sbyte, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(short))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<short, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(ushort))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<ushort, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(int))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<int, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(uint))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<uint, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(long))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<long, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(ulong))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<ulong, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(float))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<float, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(decimal))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<decimal, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(double))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<double, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(Vector2))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<Vector2, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(Vector3))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<Vector3, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else if (typeof(TValue) == typeof(RectangleF))
                    FUNCTION =
                        (InterpolationFunc<TValue, TEasing>)
                            (object)
                                (InterpolationFunc<RectangleF, TEasing>)
                                    GenericInterpolation<TEasing>.ValueAt;
                else
                    throw new NotSupportedException(
                        $"Type {typeof(TValue)} has no interpolation function. Implement the interface {typeof(IInterpolable<TValue>)} interface on the object."
                    );
            }
        }
    }

    public delegate TValue InterpolationFunc<TValue, TEasing>(
        double time,
        TValue startValue,
        TValue endValue,
        double startTime,
        double endTime,
        in TEasing easingType
    )
        where TEasing : IEasingFunction;
}
