...
#pragma warning restore RS0030
            ...
            bool entryIsKnownTestAssembly =
                entry != null
                && (
                    assemblyName!.Contains("testhost")
                    || assemblyName.Contains("ReSharperTestRunner")
                );
            ...
            bool nullEntryWithActualTestContext =
                entry == null
                && TestContext.CurrentContext.Test.ClassName
                    != typeof(TestExecutionContext.AdhocContext).FullName;
        ...
        private static readonly Lazy<Assembly> nunit_test_assembly = new Lazy<Assembly>(() =>
        {
            ...
            return AppDomain
                ...
                .First(asm => asm.GetType(testName) != null);
        });
        ...
        private static readonly Lazy<bool> is_debug_build = new Lazy<bool>(() =>
            ...
            || isDebugAssembly(RuntimeInfo.EntryAssembly)
        );
