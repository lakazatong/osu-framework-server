...
namespace osu.Framework.Tests.Visual.Drawables
{
    [System.ComponentModel.Description(
        "Approximate a hand-drawn path with minimal B-spline control points"
    )]
    public partial class TestSceneInteractivePathDrawing : FrameworkTestScene
    {
        ...
        public TestSceneInteractivePathDrawing()
        {
            Child = new Container
            {
                ...
                {
                    rawDrawnPath = new Path { Colour = Color4.DeepPink, PathRadius = 5 },
                    approximatedDrawnPath = new Path { Colour = Color4.Blue, PathRadius = 3 },
            ...
            AddSliderStep(
                $"{nameof(bSplineBuilder.Tolerance)}",
                0f,
                3f,
                2f,
                v =>
            ...
            AddSliderStep(
                $"{nameof(bSplineBuilder.CornerThreshold)}",
                0f,
                1f,
                0.4f,
                v =>
        ...
        protected override bool OnDragStart(DragStartEvent e)
        {
            ...
            {
                bSplineBuilder.Clear();
                bSplineBuilder.AddLinearPoint(
                    rawDrawnPath.ToLocalSpace(ToScreenSpace(e.MousePosition))
                );
                return true;
            }
