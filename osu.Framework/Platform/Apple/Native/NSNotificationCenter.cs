...
namespace osu.Framework.Platform.Apple.Native
{
    internal static class NSNotificationCenter
    {
        ...
        private static readonly IntPtr sel_add_observer = Selector.Get(
            "addObserver:selector:name:object:"
        );

        internal static IntPtr Handle = Interop.SendIntPtr(
            Class.Get("NSNotificationCenter"),
            sel_default_center
        );

        internal static readonly IntPtr WINDOW_DID_ENTER_FULL_SCREEN = Interop.GetStringConstant(
            Interop.AppKitLibrary,
            "NSWindowDidEnterFullScreenNotification"
        );
        internal static readonly IntPtr WINDOW_DID_EXIT_FULL_SCREEN = Interop.GetStringConstant(
            Interop.AppKitLibrary,
