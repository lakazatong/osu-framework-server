...
namespace osu.Framework.Tests.Containers
{
    ...
    public partial class TestSceneEnumeratorVersion : FrameworkTestScene
    {
        ...
        public void SetUp() =>
            Schedule(() =>
            {
                Child = parent = new Container { Child = new Container() };
            });
        ...
        {
            AddStep(
                "iterate through parent doing nothing",
                () =>
                    Assert.DoesNotThrow(() =>
                    {
        ...
        {
            AddStep(
                "adding child during enumeration fails",
                () =>
        ...
        {
            AddStep(
                "removing child during enumeration fails",
                () =>
                    Assert.Throws<InvalidOperationException>(() =>
                    {
        ...
        {
            AddStep(
                "clearing children during enumeration fails",
                () =>
                    Assert.Throws<InvalidOperationException>(() =>
                    {
                        foreach (var _ in parent)
