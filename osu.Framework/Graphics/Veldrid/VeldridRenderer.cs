...
namespace osu.Framework.Graphics.Veldrid
{
    internal class VeldridRenderer : Renderer, IVeldridRenderer
    {
        ...
        )
        {
            ...
            graphicsPipeline.DrawVertices(
                topology.ToPrimitiveTopology(),
                vertexStart,
                verticesCount
            );
        }
        ...
        protected internal override Image<Rgba32>? ExtractFrameBufferData(
        ...
        public void UpdateTexture<T>(
            global::Veldrid.Texture texture,
            int x,
            int y,
            int width,
            int height,
            ...
            where T : unmanaged
        {
            ...
            textureUploadPipeline.UpdateTexture(
                stagingTexturePool,
                texture,
                x,
                y,
        ...
        public void UpdateTexture(
            ...
            bufferUpdatePipeline.UpdateTexture(
                stagingTexturePool,
                texture,
                x,
                y,
