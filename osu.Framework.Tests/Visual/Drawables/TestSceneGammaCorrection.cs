                ...
                Child = new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        new SpriteText
                        {
                            ...
                            Origin = Anchor.CentreLeft,
                            Text =
                                $"{nameof(Interpolation)}.{nameof(Interpolation.ValueAt)}(Red, Blue) with 1px boxes",
                        },
                        ...
                        new SpriteText
                        {
                            ...
                            Margin = new MarginPadding { Top = 20f },
                            Text =
                                $"{nameof(ColourInfo)}.{nameof(ColourInfo.GradientHorizontal)}(Red, Blue)",
                        },
                        new Box
                        {
                            Anchor = Anchor.CentreLeft,
