...
namespace osu.Framework.Tests.Visual.Containers
{
    public partial class TestSceneMasking : FrameworkTestScene
    {
        ...
        {
            Add(TestContainer = new Container { RelativeSizeAxes = Axes.Both });
        ...
        private void loadTest(int testType)
        {
            ...
            switch (testType)
            {
                ...
                case 3:
                {
                    ...
                    box1.OnUpdate += delegate
                    {
                        box1.Rotation += 0.07f;
                    };
                    box2.OnUpdate += delegate
                    {
                        box2.Rotation -= 0.15f;
                    };
                    break;
                    ...
                    TestContainer.Add(
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                {
                                    Text =
                                        $"None of the folowing {nameof(CircularContainer)}s should trigger until the white part is hovered",
                                },
                                new FillFlowContainer
                                {
                                    Direction = FillDirection.Vertical,
                                    ...
                                    Children = new Drawable[]
                                    {
                                        new SpriteText { Text = "No masking" },
                                ...
                                new FillFlowContainer
                                {
                                    ...
                                    Children = new Drawable[]
                                    {
                                        new SpriteText { Text = "With masking" },
                                        new CircularContainerWithInput
                                        {
                                            Size = new Vector2(200),
                                            Masking = true,
                ...
                case 8:
                    TestContainer.Add(
                        new Container
                        {
                            ...
                            c.OnLoadComplete += _ =>
                            {
                                c.ResizeWidthTo(-200, 1000, Easing.InOutSine)
                                    .Then()
                                    .ResizeHeightTo(-200, 1000, Easing.InOutSine)
                                    .Then()
                                    .ResizeTo(new Vector2(200, 200), 1000)
                                    .Loop();
                            }
                        )
                    );
