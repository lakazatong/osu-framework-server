...
namespace osu.Framework.Extensions.PolygonExtensions
{
    ...
    public static class ConvexPolygonExtensions
    {
            ...
            where TPolygon2 : IConvexPolygon
        {
            ...
            Span<Vector2> axisBuffer =
                stackalloc Vector2[Math.Max(firstVertices.Length, secondVertices.Length)];

            bool result = intersects(first.GetAxes(axisBuffer), firstVertices, secondVertices);
            result =
                result && intersects(second.GetAxes(axisBuffer), firstVertices, secondVertices);
        ...
        private static bool intersects(
            ReadOnlySpan<Vector2> axes,
            ReadOnlySpan<Vector2> firstVertices,
