    ...
    public partial class TestSceneLifetimeManagementContainer : FrameworkTestScene
    {
        ...
        public void SetUp() =>
            Schedule(() =>
            {
                ...
                {
                    container = new TestContainer { Clock = new FramedClock(manualClock) },
                };
            });
                ...
                () =>
                {
                    ...
                    foreach (var child in container.InternalChildren)
                    {
                        ...
                        Assert.AreEqual(
                            child.ShouldBeAlive,
                            child.IsAlive,
                            $"Aliveness is invalid for {child}"
                        );
                    }
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    container.OnCrossing += e =>
                    {
                        ...
                        if (
                            kind == LifetimeBoundaryKind.End
                            && direction == LifetimeBoundaryCrossingDirection.Forward
                        )
                            a.LifetimeEnd = 2;
                        else if (
        ...
        public void TestLifetimeMutatingChildren()
        {
            ...
            TestLifetimeMutatingChild first = null,
                second = null;
            AddStep(
                "add children",
                () =>
            ...
            AddStep(
                "process single frame when children alive",
                () =>
                {
        ...
        public partial class TestChild : SpriteText
        {
            ...
            public List<LifetimeBoundaryCrossedEvent> Crossings =
                new List<LifetimeBoundaryCrossedEvent>();
            ...
            protected override void Update()
            {
                Y = ChildID * Font.Size;
                Text =
                    $"{ChildID}: {LifetimeStart}..{LifetimeEnd} [{string.Join(", ", Crossings.Select(x => x.ToString()))}]";
            }
            ...
            public void CheckCrossings(params LifetimeBoundaryCrossedEvent[] expected)
            {
                Assert.AreEqual(
                    expected,
                    Crossings,
                    $"{nameof(CheckCrossings)} for child {ChildID}"
                );
                Crossings.Clear();
            }
        }
