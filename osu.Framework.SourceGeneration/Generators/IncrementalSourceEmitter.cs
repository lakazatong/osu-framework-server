...
";
        ...
        public void Emit(AddSourceDelegate addSource)
        {
            ...
            {
                result.Append(emitTypeTree().NormalizeWhitespace());
            }
            else
            {
                result.Append(
                    SyntaxFactory
                        ...
                        .WithMembers(SyntaxFactory.SingletonList(emitTypeTree()))
                        .NormalizeWhitespace()
                );
            }
        ...
        protected abstract ClassDeclarationSyntax ConstructClass(
        ...
        private MemberDeclarationSyntax emitTypeTree()
        {
            ...
            for (int i = 0; i < classes.Count - 1; i++)
                classes[i + 1] = classes[i + 1]
                    .WithMembers(SyntaxFactory.List<MemberDeclarationSyntax>(new[] { classes[i] }));
