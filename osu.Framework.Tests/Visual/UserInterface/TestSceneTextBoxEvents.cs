    ...
    public partial class TestSceneTextBoxEvents : ManualInputManagerTestScene
    {
        ...
        public void SetUpSteps()
        {
            ...
            AddStep(
                "add textbox",
                () =>
                    textInputContainer.Add(
                        textBox = new EventQueuesTextBox
                        {
            ...
            AddStep(
                "dequeue text input activated event",
                () => textInput.ActivationQueue.Dequeue()
            );
        ...
        {
            AddStep(
                "add handler to reset on commit",
                () =>
                    textBox.OnCommit += (_, isNew) =>
                    {
                        if (!isNew)
                            return;
            ...
            AddAssert(
                "text committed event raised with new",
        ...
        public void TestMutatingTextPropertyDoesntInvokeEvent()
        {
            ...
            AddStep(
                "insert string via protected method",
                () => textBox.InsertString(" inserted string.")
            );
            AddAssert(
                "no user text consumed event",
        ...
        {
            AddStep(
                "press letter key to insert text",
                () =>
                {
        ...
        public void TestDeletingPrevCharActionInvokesEvent()
        {
            ...
            AddAssert(
                "user text removed event raised",
                () =>
                    textBox.UserRemovedTextQueue.Dequeue() == lastText.Last().ToString()
        ...
        public void TestCommittingTextInvokesEvents()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.MoveMouseTo(
                        textBox.ScreenSpaceDrawQuad.BottomRight + Vector2.One * 20
                    );
                    InputManager.Click(MouseButton.Left);
                }
            );
            ...
            AddAssert(
                ...
                () =>
                    ...
                    textBox.CommittedTextQueue.Dequeue() == false
                    && textBox.CommittedTextQueue.Count == 0
            );
            ...
            AddAssert(
                "input deactivated",
                () =>
                    textInput.DeactivationQueue.Dequeue() && textInput.DeactivationQueue.Count == 0
            );
        }
        ...
        public void TestMovingOrExpandingSelectionInvokesEvent()
        {
            // Selecting Forward
            AddStep(
                "invoke move action to move caret",
            ...
            AddAssert(
                ...
                () =>
                    ...
                    textBox.CaretMovedQueue.Dequeue() == false
                    && textBox.CommittedTextQueue.Count == 0
            );

            AddStep(
                "invoke select action to expand selection",
                () => InputManager.Keys(PlatformAction.SelectForwardChar)
            );
            AddAssert(
                "text selection event (character)",
                () => textBox.TextSelectionQueue.Dequeue() == TextBox.TextSelectionType.Character
            );
            AddAssert(
                "caret moved event",
                () =>
            ...
            AddStep(
                "invoke select action to expand selection",
                () => InputManager.Keys(PlatformAction.SelectForwardWord)
            );
            AddAssert(
                "text selection event (word)",
                () => textBox.TextSelectionQueue.Dequeue() == TextBox.TextSelectionType.Word
            );
            AddAssert(
                "caret moved event",
                () =>
            ...
            AddStep(
                "invoke select action to expand selection",
                () => InputManager.Keys(PlatformAction.SelectBackwardChar)
            );
            AddAssert(
                "text selection event (character)",
                () => textBox.TextSelectionQueue.Dequeue() == TextBox.TextSelectionType.Character
            ...
            AddAssert(
                "text selection event (all)",
                () => textBox.TextSelectionQueue.Dequeue() == TextBox.TextSelectionType.All
            );
            ...
            AddAssert(
                "text input ensure activated",
                () =>
                    textInput.EnsureActivatedQueue.Dequeue() != default
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    InputManager.MoveMouseTo(
                        textInputContainer.ToScreenSpace(
                            textBox.DrawRectangle.Centre + new Vector2(50, 0)
                        )
                    );
        ...
        public void TestSelectAfterOutOfBandSelectionChange()
        {
            ...
            AddAssert(
                "user text removed event raised",
                () => textBox.UserRemovedTextQueue.Dequeue() == default_text
            );

            AddAssert("no text is selected", () => textBox.SelectedText, () => Is.Empty);
            AddStep(
                "invoke caret select action",
                () => InputManager.Keys(PlatformAction.SelectForwardChar)
            );
            AddAssert("no text is selected", () => textBox.SelectedText, () => Is.Empty);

            AddAssert(
                "no text selection event",
                () => textBox.TextSelectionQueue,
                () => Has.Exactly(0).Items
            );
        }
        ...
        public void TestImeResultInvokesEvent()
        {
            ...
            AddAssert(
                "ime result event raised",
                () =>
                    textBox
                        .ImeResultQueue.Dequeue()
                        .Equals(new ImeResultEvent { Result = composition_text, Successful = true })
            );
        ...
        public void TestPressingKeysDuringImeCompositionOnlyInvokesCompositionEvent()
        {
            ...
            AddStep(
                "press left arrow and move selection in composition",
                () =>
                {
                    textInput.TriggerImeComposition(
                        composition_text,
                        composition_text.Length - 1,
                        0
                    );
            ...
            AddAssert(
                "ime composition event raised",
                () =>
                    textBox
                        .ImeCompositionQueue.Dequeue()
                        .Equals(
                            new ImeCompositionEvent
                            {
            ...
            AddStep(
                "press backspace to delete character in composition",
                () =>
                {
                    textInput.TriggerImeComposition(
                        composition_text[..^1],
                        composition_text.Length - 2,
                        0
                    );
                    InputManager.Keys(PlatformAction.DeleteBackwardChar);
                }
            ...
            AddAssert(
                "user text removed event not raised",
                () => textBox.UserRemovedTextQueue.Count == 0
            );

            AddStep(
                "press enter and complete composition",
                () =>
                {
            ...
            AddAssert(
                "text committed event not raised",
                () => textBox.CommittedTextQueue.Count == 0
            );
        ...
        public void TestInvalidCompositionInvokesInputError()
        {
            ...
            AddStep(
                "trigger composition with invalid selection start",
                () =>
                {
                    textInput.TriggerImeComposition(
                        composition_text,
            ...
            AddStep(
                "trigger composition with invalid selection length",
                () =>
                {
                    textInput.TriggerImeComposition(
                        composition_text,
        ...
        public void TestLengthLimitTruncatesComposition()
        {
            AddStep(
                "set length limit",
                () => textBox.LengthLimit = default_text.Length + composition_text.Length - 1
            );
            ...
            AddAssert(
                "truncated ime composition event raised",
                () =>
                    textBox
                        .ImeCompositionQueue.Dequeue()
                        .Equals(
        ...
        public void TestInvalidCharactersRemovedFromComposition()
        {
            ...
            AddStep(
                "start composition with invalid characters",
                () =>
                    textInput.TriggerImeComposition(
                        invalid_composition,
                        invalid_composition.Length,
                        0
                    )
            );
            AddAssert(
                "ime composition event with valid composition raised",
                () =>
                    textBox
                        .ImeCompositionQueue.Dequeue()
                        .Equals(
        ...
        public void TestDisablingCurrentStopsComposition()
        {
            ...
            AddAssert(
                ...
                () => textBox.Current.Value == default_text + composition_text
            );
        ...
        public void TestReadOnlyTextBoxDoesntReceiveInput()
        {
            ...
            assertCompositionNotActive();
            AddStep(
                "press key to insert normal text",
                () =>
                {
                    textInput.Text("W");
                    InputManager.Key(Key.W);
            ...
            AddAssert(
                "user text consumed event not raised",
                () => textBox.UserConsumedTextQueue.Count == 0
            );
        }
        ...
        public void TestChangingFocusDoesNotReactivate(bool allowIme)
        {
            ...
            AddStep(
                ...
                () =>
                    textInputContainer.Add(
                        secondTextBox = new EventQueuesTextBox
                        {
            ...
            AddAssert("text input not activated again", () => textInput.ActivationQueue.Count == 0);
            AddAssert(
                $"text input ensure activated {(allowIme ? "with" : "without")} IME",
                () =>
                    textInput.EnsureActivatedQueue.Dequeue().AllowIme == allowIme
                    && textInput.EnsureActivatedQueue.Count == 0
            );
        ...
        private void assertCompositionNotActive()
        {
            ...
            AddAssert(
                "ime composition event not raised",
                () => textBox.ImeCompositionQueue.Count == 0
            );
        }
        ...
        private void testNormalTextInput()
        {
            ...
            AddAssert(
                "user text consumed event raised",
                () =>
                    textBox.UserConsumedTextQueue.Dequeue() == "W"
                    && textBox.UserConsumedTextQueue.Count == 0
            );
        ...
        public partial class EventQueuesTextBox : TestSceneTextBox.InsertableTextBox
        {
            ...
            public readonly Queue<ImeCompositionEvent> ImeCompositionQueue =
                new Queue<ImeCompositionEvent>();
            public readonly Queue<ImeResultEvent> ImeResultQueue = new Queue<ImeResultEvent>();
            public readonly Queue<TextSelectionType> TextSelectionQueue =
                new Queue<TextSelectionType>();
            ...
            protected override void OnUserTextAdded(string consumed) =>
                UserConsumedTextQueue.Enqueue(consumed);

            protected override void OnUserTextRemoved(string removed) =>
                UserRemovedTextQueue.Enqueue(removed);

            protected override void OnTextCommitted(bool textChanged) =>
                CommittedTextQueue.Enqueue(textChanged);

            protected override void OnCaretMoved(bool selecting) =>
                CaretMovedQueue.Enqueue(selecting);
            ...
            protected override void OnImeResult(string result, bool successful) =>
                ImeResultQueue.Enqueue(
                    new ImeResultEvent { Result = result, Successful = successful }
                );

            protected override void OnTextSelectionChanged(TextSelectionType selectionType) =>
                TextSelectionQueue.Enqueue(selectionType);
        ...
        public struct ImeCompositionEvent
        {
            ...
            public bool Equals(ImeCompositionEvent other) =>
                NewComposition == other.NewComposition
        ...
        public struct ImeResultEvent
        {
            ...
            public bool Equals(ImeResultEvent other) =>
                Result == other.Result && Successful == other.Successful;
        }
    }
}
