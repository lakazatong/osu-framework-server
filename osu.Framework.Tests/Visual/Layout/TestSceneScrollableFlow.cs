    ...
    public partial class TestSceneScrollableFlow : FrameworkTestScene
    {
        ...
        public TestSceneScrollableFlow()
        {
            ...
            AddStep(
                ...
                delegate
                {
                    createArea(scrollDir = Direction.Horizontal);
                }
            );
            ...
            AddStep(
                ...
                delegate
                {
                    scroll.ScrollbarAnchor =
                        scrollDir == Direction.Vertical ? Anchor.TopRight : Anchor.BottomLeft;
                }
            );
            AddStep(
                "Dragger Anchor 2",
                delegate
                {
                    scroll.ScrollbarAnchor = Anchor.TopLeft;
                }
            );
            ...
            AddStep(
                ...
                delegate
                {
                    scroll.ScrollbarVisible = !scroll.ScrollbarVisible;
                }
            );
            AddStep(
                "Dragger Overlap",
                delegate
                {
                    scroll.ScrollbarOverlapsContent = !scroll.ScrollbarOverlapsContent;
                }
            );
            ...
            Scheduler.AddDelayed(
                delegate
                {
                    ...
                    box.Delay(displayTime)
                        .ScaleTo(0.5f, 4000)
                        .RotateTo((RNG.NextSingle() - 0.5f) * 90, 4000);
