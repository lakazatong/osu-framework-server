...
namespace osu.Framework.Tests.Visual.Drawables
{
    public partial class TestSceneTransformSequence : GridTestScene
    {
        ...
        public void TestValidation()
        {
            ...
            AddStep(
                "nan width",
                () => Assert.Throws<ArgumentException>(() => boxes[0].ResizeWidthTo(float.NaN))
            );
            AddStep(
                "nan width sequence",
                () =>
                    Assert.Throws<ArgumentException>(() =>
                        boxes[0].FadeIn(200).ResizeWidthTo(float.NaN)
                    )
            );
            AddStep(
                "zero child size",
                () =>
                    Assert.Throws<ArgumentException>(() =>
                        boxes[0].TransformRelativeChildSizeTo(Vector2.Zero)
                    )
            );
        }
        ...
        private void animate()
        {
            boxes[0]
                ...
                .Then(500)
                .Then(500)
                .Then(b => b.Delay(500).Spin(1000, RotationDirection.Counterclockwise));

            boxes[1].Spin(1000, RotationDirection.Counterclockwise);

            boxes[2].Delay(-2000).Spin(1000, RotationDirection.Counterclockwise);

            boxes[3].RotateTo(90).Then().Delay(1000).RotateTo(0).Then().RotateTo(180, 1000).Loop();
            ...
            boxes[5]
                ...
                .ScaleTo(1)
                .RotateTo(360, 1000)
                .Then(1000, b => b.RotateTo(0, 1000), b => b.ScaleTo(2, 500))
                .Then()
                .RotateTo(360, 1000)
                .ScaleTo(0.5f, 1000)
                .Then()
                .FadeEdgeEffectTo(Color4.Red, 1000)
                .ScaleTo(2, 500);
            ...
            boxes[6]
                ...
                .ScaleTo(1)
                .RotateTo(360, 500)
                .Then(1000, b => b.RotateTo(0), b => b.ScaleTo(2))
                .Then(b =>
                    b.Loop(500, 2, d => d.RotateTo(0).RotateTo(360, 1000))
                        .Delay(500)
                        .ScaleTo(0.5f, 500)
                )
                .Then()
            ...
            boxes[9].RotateTo(200).Finally(b => b.FadeEdgeEffectTo(Color4.Red, 1000));

            boxes[10].Delay(-1000).RotateTo(200).Finally(b => b.FadeEdgeEffectTo(Color4.Red, 1000));
