...
namespace osu.Framework.Graphics.Rendering.Deferred
{
    internal class DeferredRenderer : Renderer, IVeldridRenderer
    {
        ...
        private readonly HashSet<IVeldridUniformBuffer> uniformBufferResetList =
            new HashSet<IVeldridUniformBuffer>();
        ...
        void IVeldridRenderer.UpdateTexture<T>(
            Texture texture,
            int x,
            int y,
            int width,
        ...
        void IVeldridRenderer.UpdateTexture(
            Texture texture,
            int x,
            int y,
            int width,
        ...
        void IRenderer.ExitDrawNode() =>
            Context.EnqueueEvent(
                DrawNodeActionEvent.Create(this, drawNodeStack.Pop(), DrawNodeActionType.Exit)
            );
        ...
        protected override IShader CreateShader(
            ...
            new DeferredShader(
                ...
                new VeldridShader(
                    this,
                    name,
                    parts.Cast<VeldridShaderPart>().ToArray(),
                    compilationStore
                )
            );
        ...
        public override IFrameBuffer CreateFrameBuffer(
            ...
            new DeferredFrameBuffer(
                this,
                renderBufferFormats?.ToPixelFormats(),
                filteringMode.ToSamplerFilter()
            );
        ...
        protected override IVertexBatch<TVertex> CreateQuadBatch<TVertex>(
            ...
            new DeferredVertexBatch<TVertex>(
                this,
