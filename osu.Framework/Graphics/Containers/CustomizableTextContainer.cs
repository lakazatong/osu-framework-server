...
namespace osu.Framework.Graphics.Containers
{
    ...
    public partial class CustomizableTextContainer : TextFlowContainer
    {
        ...
        public static string Escape(string text) =>
            text.Replace(UNESCAPED_LEFT, ESCAPED_LEFT).Replace(UNESCAPED_RIGHT, ESCAPED_RIGHT);

        public static string Unescape(string text) =>
            text.Replace(ESCAPED_LEFT, UNESCAPED_LEFT).Replace(ESCAPED_RIGHT, UNESCAPED_RIGHT);
        ...
        private readonly Dictionary<string, Delegate> iconFactories =
        ...
        internal bool TryGetIconFactory(string name, out Delegate iconFactory) =>
            iconFactories.TryGetValue(name, out iconFactory);

        protected internal override TextChunk<TSpriteText> CreateChunkFor<TSpriteText>(
            LocalisableString text,
            bool newLineIsParagraph,
            Func<TSpriteText> creationFunc,
            Action<TSpriteText> creationParameters = null
        ) =>
            new CustomizableTextChunk<TSpriteText>(
                text,
                newLineIsParagraph,
                creationFunc,
                creationParameters
