...
namespace osu.Framework.Graphics.Veldrid.Buffers
{
        ...
        where T : unmanaged, IEquatable<T>, IVertex
    {
        ...
        DeviceBuffer IVeldridVertexBuffer<T>.Buffer =>
            buffer ?? throw new InvalidOperationException("The buffer is not initialised yet.");
        ...
        public bool SetVertex(int vertexIndex, T vertex)
        {
            ...
            bool isNewVertex =
                vertexIndex > lastWrittenVertexIndex || !currentVertex.Equals(vertex);
        ...
        private void initialiseGpuBuffer()
        {
            ...
            buffer = renderer.Factory.CreateBuffer(
                new BufferDescription(
                    (uint)(Size * VeldridVertexUtils<T>.STRIDE),
                    BufferUsage.VertexBuffer | stagingBuffer.CopyTargetUsageFlags
                )
            );
