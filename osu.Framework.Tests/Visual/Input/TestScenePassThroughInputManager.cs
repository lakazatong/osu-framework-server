...
namespace osu.Framework.Tests.Visual.Input
{
    public partial class TestScenePassThroughInputManager : ManualInputManagerTestScene
    {
        ...
        public void UseParentInputChange()
        {
            ...
            AddAssert(
                ...
                () =>
                    ...
                    && joystick.IsPressed(JoystickButton.Button1)
            );
        ...
        public void TestKeyInput()
        {
            ...
            AddAssert(
                "key pressed",
                () => testInputManager.CurrentState.Keyboard.Keys.Single() == Key.A
            );

            AddStep("release key", () => InputManager.ReleaseKey(Key.A));
            AddAssert(
                "key released",
                () => !testInputManager.CurrentState.Keyboard.Keys.HasAnyButtonPressed
            );
        ...
        public void TestPressKeyThenReleaseWhileDisabled()
        {
            ...
            AddStep(
                "add blocking layer",
                () => Add(new HandlingBox { RelativeSizeAxes = Axes.Both, OnHandle = _ => true })
            );
        ...
        public void TestTouchInput()
        {
            ...
            AddAssert(
                ...
                () =>
                    ...
                    && testInputManager.CurrentState.Touch.TouchPositions[(int)TouchSource.Touch1]
                        == Vector2.Zero
            );
            ...
            AddStep(
                "begin second touch",
                () => InputManager.BeginTouch(new Touch(TouchSource.Touch2, Vector2.One))
            );

            AddAssert(
                "only first touch active",
                () =>
                    testInputManager.CurrentState.Touch.ActiveSources.Single() == TouchSource.Touch1
                    && testInputManager.CurrentState.Touch.TouchPositions[(int)TouchSource.Touch1]
                        == Vector2.Zero
        ...
        public void TestMidiInput()
        {
            ...
            AddAssert(
                "C3 released",
                () => !testInputManager.CurrentState.Midi.Keys.HasAnyButtonPressed
            );
        ...
        public void TestTabletButtonInput()
        {
            ...
            AddStep(
                "press primary pen button",
                () => InputManager.PressTabletPenButton(TabletPenButton.Primary)
            );
            AddStep(
                "press auxiliary button 4",
                () => InputManager.PressTabletAuxiliaryButton(TabletAuxiliaryButton.Button4)
            );
            AddAssert(
                "primary pen button pressed",
                () =>
                    testInputManager.CurrentState.Tablet.PenButtons.Single()
                    == TabletPenButton.Primary
            );
            AddAssert(
                "auxiliary button 4 pressed",
                () =>
                    testInputManager.CurrentState.Tablet.AuxiliaryButtons.Single()
                    == TabletAuxiliaryButton.Button4
            );

            AddStep(
                "release primary pen button",
                () => InputManager.ReleaseTabletPenButton(TabletPenButton.Primary)
            );
            AddStep(
                "release auxiliary button 4",
                () => InputManager.ReleaseTabletAuxiliaryButton(TabletAuxiliaryButton.Button4)
            );
            AddAssert(
                "primary pen button pressed",
                () => !testInputManager.CurrentState.Tablet.PenButtons.HasAnyButtonPressed
            );
            AddAssert(
                "auxiliary button 4 pressed",
                () => !testInputManager.CurrentState.Tablet.AuxiliaryButtons.HasAnyButtonPressed
            );
            ...
            AddStep(
                "press secondary pen button",
                () => InputManager.PressTabletPenButton(TabletPenButton.Secondary)
            );
            AddStep(
                "press auxiliary button 2",
                () => InputManager.PressTabletAuxiliaryButton(TabletAuxiliaryButton.Button2)
            );

            AddAssert(
                "only primary pen button pressed",
                () =>
                    testInputManager.CurrentState.Tablet.PenButtons.Single()
                    == TabletPenButton.Primary
            );
            AddAssert(
                "only auxiliary button 4 pressed",
                () =>
                    testInputManager.CurrentState.Tablet.AuxiliaryButtons.Single()
                    == TabletAuxiliaryButton.Button4
            );
            ...
            AddStep("UseParentInput = true", () => testInputManager.UseParentInput = true);
            AddAssert(
                "primary pen button released",
                () => !testInputManager.CurrentState.Tablet.PenButtons.HasAnyButtonPressed
            );
            AddAssert(
                "auxiliary button 4 released",
                () => !testInputManager.CurrentState.Tablet.AuxiliaryButtons.HasAnyButtonPressed
            );
        }
            ...
            AddStep(
                ...
                () =>
                    InputManager.BeginTouch(
                        new Touch(TouchSource.Touch1, testInputManager.ScreenSpaceDrawQuad.Centre)
                    )
            );
            AddAssert(
                "ensure parent manager produced press",
                () => InputManager.CurrentState.Mouse.Buttons.Single() == MouseButton.Left
            );

            AddAssert(
                "pass-through did not produce press",
        ...
        public void TestPenInputPassThrough()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    testInputManager.Add(
                        inner = new MouseBox { Alpha = 0.5f, RelativeSizeAxes = Axes.Both }
                    );
                }
            );
            ...
            AddAssert(
                "ensure parent manager produced mouse",
                () =>
                    InputManager.CurrentState.Mouse.Position
                    == testInputManager.ScreenSpaceDrawQuad.Centre
            );
            AddAssert(
                "ensure pass-through produced mouse",
                () =>
                    testInputManager.CurrentState.Mouse.Position
                    == testInputManager.ScreenSpaceDrawQuad.Centre
            );

            AddAssert("outer box received 1 pen event", () => outer.PenEvents, () => Is.EqualTo(1));
            AddAssert(
                "outer box received no mouse events",
                () => outer.MouseEvents,
                () => Is.EqualTo(0)
            );
            ...
            AddAssert(
                "inner box received no mouse events",
                () => inner.MouseEvents,
                () => Is.EqualTo(0)
            );
            ...
            AddAssert(
                "outer box received 2 pen events",
                () => outer.PenEvents,
                () => Is.EqualTo(2)
            );
            AddAssert(
            ...
            AddAssert(
                "inner box received 2 pen events",
                () => inner.PenEvents,
                () => Is.EqualTo(2)
            );
            AddAssert(
            ...
            AddAssert(
                "outer box received 3 pen events",
                () => outer.PenEvents,
                () => Is.EqualTo(3)
            );
            AddAssert(
            ...
            AddAssert(
                "inner box received 3 pen events",
                () => inner.PenEvents,
                () => Is.EqualTo(3)
            );
            AddAssert(
        ...
        public void TestInitialMousePositionSynced()
        {
            ...
            AddStep(
                "load test input manager and immediately read mouse position",
                () =>
                {
            ...
            AddAssert(
                "mouse position synced",
                () => immediateMousePosition,
                () => Is.EqualTo(InputManager.CurrentState.Mouse.Position)
            );
        }
