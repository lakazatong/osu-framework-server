...
namespace osu.Framework.Tests.Visual.UserInterface
{
    public partial class TestSceneDropdown : ManualInputManagerTestScene
    {
        ...
        public void TestSelectByUserInteraction()
        {
            ...
            AddAssert(
                "item 2 is selected",
                () => testDropdown.Current.Value?.Equals(testDropdown.Items.ElementAt(2)) == true
            );
            AddAssert(
                "item 2 is selected item",
                () => testDropdown.SelectedItem.Value?.Identifier == "test 2"
            );
            AddAssert(
                "item 2 is visually selected",
                () =>
                    (
                        testDropdown
                            .ChildrenOfType<Dropdown<TestModel?>.DropdownMenu.DrawableDropdownMenuItem>()
                            .SingleOrDefault(i => i.IsSelected)
                            ?.Item as DropdownMenuItem<TestModel?>
                    )
                        ?.Value
                        ?.Identifier == "test 2"
            );
        ...
        public void TestSelectByCurrent()
        {
            ...
            AddStep(
                "update current to item 3",
                () => testDropdown.Current.Value = testDropdown.Items.ElementAt(3)
            );

            AddAssert(
                "item 3 is selected",
                () => testDropdown.Current.Value?.Equals(testDropdown.Items.ElementAt(3)) == true
            );
            AddAssert(
                "item 3 is selected item",
                () => testDropdown.SelectedItem.Value?.Identifier == "test 3"
            );
            AddAssert(
                "item 3 is visually selected",
                () =>
                    (
                        testDropdown
                            .ChildrenOfType<Dropdown<TestModel?>.DropdownMenu.DrawableDropdownMenuItem>()
        ...
        public void TestDropdownHeight()
        {
            ...
            AddAssert(
                ...
                () => testDropdown.Items.Count() == items_to_add * 2
            );

            AddStep(
                $"Set dropdown1 height to {explicit_height}",
                () =>
                {
            ...
            AddAssert(
                $"dropdown1 height is {explicit_height}",
                () => testDropdown.Menu.Height == explicit_height
            );

            AddStep(
                $"Set dropdown1 height to {float.PositiveInfinity}",
                () => testDropdown.Menu.MaxHeight = float.PositiveInfinity
            );
            AddAssert(
                "dropdown1 height is calculated automatically",
        ...
        public void TestKeyboardSelection(bool cleanSelection)
        {
            ...
            AddAssert(
                ...
                () => testDropdown.SelectedIndex == previousIndex + 1
            );
            ...
            AddAssert(
                ...
                () => testDropdown.SelectedIndex == Math.Max(0, previousIndex - 1)
            );

            AddStep("select last item", () => InputManager.Keys(PlatformAction.MoveToListEnd));
            AddAssert(
                "last item selected",
                () => testDropdown.SelectedItem == testDropdown.Menu.VisibleMenuItems.Last().Item
            );

            AddStep("select last item", () => InputManager.Keys(PlatformAction.MoveToListStart));
            AddAssert(
                "first item selected",
                () => testDropdown.SelectedItem == testDropdown.Menu.VisibleMenuItems.First().Item
            );
        ...
        public void TestReplaceItems()
        {
            ...
            AddAssert(
                "item 4 is selected",
                () => testDropdown.Current.Value?.Identifier == "test 4"
            );
            ...
            AddStep(
                ...
                () =>
                {
                    testDropdown.Items = testDropdown
                        .Items.Select(i => new TestModel(i.AsNonNull().ToString()))
                        .ToArray();
                }
            );
            ...
            AddAssert(
                "item 4 is selected item",
                () => testDropdown.SelectedItem.Value?.Identifier == "test 4"
            );
            AddAssert(
                "item 4 is visually selected",
                () =>
                    (
                        testDropdown
                            .ChildrenOfType<Dropdown<TestModel?>.DropdownMenu.DrawableDropdownMenuItem>()
        ...
        public void TestInvalidCurrent()
        {
            ...
            AddAssert(
                "'invalid' is selected",
                () => testDropdown.Current.Value?.Identifier == "invalid"
            );
            AddAssert(
                "label shows 'invalid'",
                () => testDropdown.Header.Label.ToString() == "invalid"
            );
        ...
        public void TestNullCurrent()
        {
            ...
            AddStep(
                "select item 1",
                () => testDropdown.Current.Value = testDropdown.Items.ElementAt(1).AsNonNull()
            );
            AddAssert(
                "item 1 is selected",
                () => testDropdown.Current.Value?.Equals(testDropdown.Items.ElementAt(1)) == true
            );
            ...
            AddAssert(
                "label shows nothing",
                () => string.IsNullOrEmpty(testDropdown.Header.Label.ToString())
            );
        }
        ...
        public void TestDisabledCurrent()
        {
            ...
            AddStep(
                ...
                () => originalValue = testDropdown.Current.Value.AsNonNull()
            );
            ...
            void valueIsUnchanged() =>
                AddAssert(
                    "value is unchanged",
                    () => testDropdown.Current.Value?.Equals(originalValue) == true
                );
        }
        ...
        public void TestItemSource()
        {
            ...
            AddStep(
                "add items to bindable",
                () =>
                    bindableList.AddRange(
                        new[] { "one", "2", "three" }.Select(s => new TestModel(s))
                    )
            );
            ...
            AddAssert(
                "current value is still 'three'",
                () => testDropdown.Current.Value?.Identifier == "three"
            );

            AddStep("remove 'three'", () => bindableList.Remove("three"));
            AddAssert(
                "current value is 'two'",
                () => testDropdown.Current.Value?.Identifier == "two"
            );
            ...
            void checkOrder(int index, string item) =>
                AddAssert(
                    ...
                    () =>
                        testDropdown
                            .ChildrenOfType<FillFlowContainer<Menu.DrawableMenuItem>>()
                            .Single()
                            .FlowingChildren.Cast<Menu.DrawableMenuItem>()
                            .ElementAt(index)
        ...
        public void TestExternalManagement()
        {
            ...
            AddAssert(
                "search bar visible",
                () => dropdown.ChildrenOfType<DropdownSearchBar>().Single().State.Value,
            ...
            AddStep(
                "open dropdown via external button",
                () =>
                {
        ...
        public void TestItemReplacementDoesNotAffectScroll()
        {
            ...
            AddStep(
                ...
                () =>
                    bindableList.AddRange(
                        Enumerable.Range(0, 20).Select(i => (TestModel)$"test {i}")
                    )
            );
            ...
            AddAssert(
                "scroll is unchanged",
                () => testDropdown.ChildrenOfType<BasicScrollContainer>().Single().Target == 200
            );
        }
        ...
        public void TestAddItemBeforeDropdownLoad()
        {
            ...
            AddAssert(
                ...
                () =>
                    dropdown
                        .Menu.VisibleMenuItems.First()
                        .ChildrenOfType<SpriteText>()
                        .First()
                        .Text.ToString(),
                () => Is.EqualTo("loaded: test")
            );
        }
        ...
        public void TestAddItemWhileDropdownIsInReadyState()
        {
            ...
            AddAssert(
                ...
                () =>
                    dropdown
                        .Menu.VisibleMenuItems.First(d => d.IsSelected)
                        .ChildrenOfType<SpriteText>()
                        .First()
                        .Text.ToString(),
                () => Is.EqualTo("loaded: test")
        ...
        public void TestSetNonExistentItem([Values] bool afterBdl)
        {
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    bindableList.AddRange(
                        new[] { "one", "two", "three" }.Select(s => new TestModel(s))
                    );
                }
            );
            ...
            AddAssert(
                "text is expected",
                () => dropdown.SelectedItem.Text.Value.ToString(),
                () => Is.EqualTo("loaded: non-existent item")
            );
        }
        ...
        public void TestSearching()
        {
            ...
            AddAssert(
                "item preselected",
                () => dropdown.Menu.VisibleMenuItems.Single().IsPreSelected
            );
                ...
                () =>
                {
                    Add(
                        new TestKeyBindingContainer
                        {
                            ...
                            Child = keyBindingHandler =
                                new TestKeyBindingHandler { RelativeSizeAxes = Axes.Both },
                        }
                    );
                }
            );
        ...
        public void TestMouseFromTouch()
        {
            ...
            AddStep(
                "setup click handler",
                () => Add(clickHandler = new TestClickHandler { RelativeSizeAxes = Axes.Both })
            );
            ...
            AddStep(
                ...
                () =>
                    InputManager.BeginTouch(
                        new Touch(TouchSource.Touch1, dropdown.Header.ScreenSpaceDrawQuad.Centre)
                    )
            );
            AddStep(
                "end touch",
            ...
            AddAssert(
                "search bar empty",
                () => dropdown.Header.SearchTerm.Value,
                () => Is.Null.Or.Empty
            );
        ...
        private void toggleDropdownViaClick(
            Func<TestDropdown> dropdown,
            string? dropdownName = null
        ) =>
            AddStep(
                $"click {dropdownName ?? "dropdown"}",
                () =>
                {
        ...
        private void assertDropdownIsOpen(Func<TestDropdown> dropdown) =>
            AddAssert("dropdown is open", () => dropdown().Menu.State == MenuState.Open);

        private void assertDropdownIsClosed(Func<TestDropdown> dropdown) =>
            AddAssert("dropdown is closed", () => dropdown().Menu.State == MenuState.Closed);
        ...
        private partial class TestDropdown : BasicDropdown<TestModel?>
        {
            ...
            public int SelectedIndex =>
                Menu.VisibleMenuItems.Select(d => d.Item).ToList().IndexOf(SelectedItem);
            public int PreselectedIndex =>
                Menu.VisibleMenuItems.ToList().IndexOf(Menu.PreselectedItem);
        }
        ...
        private partial class TestKeyBindingContainer : KeyBindingContainer<TestAction>
        {
            public override IEnumerable<IKeyBinding> DefaultKeyBindings =>
                new[] { new KeyBinding(InputKey.Space, TestAction.SpaceAction) };
        }
