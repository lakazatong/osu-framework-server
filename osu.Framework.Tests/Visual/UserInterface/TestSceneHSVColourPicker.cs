...
namespace osu.Framework.Tests.Visual.UserInterface
{
    public partial class TestSceneHSVColourPicker : ManualInputManagerTestScene
    {
        ...
        public void HueSelectorInput()
        {
            ...
            AddStep(
                "click right edge of selector",
                () =>
                {
                    InputManager.MoveMouseTo(
                        new Vector2(
                            colourPicker.HueControl.ScreenSpaceDrawQuad.TopRight.X - 1,
                            colourPicker.HueControl.ScreenSpaceDrawQuad.Centre.Y
                        )
                    );
                    InputManager.Click(MouseButton.Left);
                }
            ...
            AddStep(
                ...
                () =>
                {
                    ...
                    InputManager.MoveMouseTo(
                        new Vector2(
                            colourPicker.HueControl.ScreenSpaceDrawQuad.TopLeft.X + 1,
                            colourPicker.HueControl.ScreenSpaceDrawQuad.Centre.Y
                        )
                    );
        ...
        public void SaturationValueSelectorInput()
        {
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        colourPicker.SaturationValueControl.ScreenSpaceDrawQuad.TopLeft
                            + new Vector2(1)
                    );
                    InputManager.Click(MouseButton.Left);
                }
            ...
            AddStep(
                ...
                () =>
                {
                    InputManager.PressButton(MouseButton.Left);
                    InputManager.MoveMouseTo(
                        colourPicker.SaturationValueControl.ScreenSpaceDrawQuad.Centre
                    );
                    InputManager.ReleaseButton(MouseButton.Left);
                }
            );
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        colourPicker.SaturationValueControl.ScreenSpaceDrawQuad.BottomLeft
                            + new Vector2(1, -1)
                    );
                    InputManager.Click(MouseButton.Left);
                }
            ...
            AddStep(
                ...
                {
                    InputManager.MoveMouseTo(
                        colourPicker.SaturationValueControl.ScreenSpaceDrawQuad.BottomRight
                            - new Vector2(1)
                    );
                    InputManager.Click(MouseButton.Left);
                }
        ...
        public void TestHueUnchangedIfSaturationAlmostZero()
        {
            AddStep(
                "change colour",
                () => colourPicker.Current.Value = Colour4.FromHSV(0.5f, 0.5f, 0.5f)
            );
            AddStep(
                "set saturation to 0",
                () => colourPicker.SaturationValueControl.Saturation.Value = 0
            );
        ...
        public void TestHueDoesNotWrapAround()
        {
            ...
            AddStep(
                "click saturation value control",
                () =>
                {
                    InputManager.MoveMouseTo(
                        colourPicker.SaturationValueControl.ScreenSpaceDrawQuad.Centre
        ...
        {
            AddAssert(
                $"hue selector has {hue}",
                () => Precision.AlmostEquals(colourPicker.HueControl.Hue.Value, hue, tolerance)
            );
            AddAssert(
                $"saturation/value selector has {hue}",
                () =>
                    Precision.AlmostEquals(
                        colourPicker.SaturationValueControl.Hue.Value,
                        hue,
                        tolerance
                    )
            );
        ...
        private void assertSaturationAndValue(
            float saturation,
            float value,
        ...
        )
        {
            AddAssert(
                ...
                () =>
                    Precision.AlmostEquals(
                        colourPicker.SaturationValueControl.Saturation.Value,
                        saturation,
                        tolerance
                    )
            );
            AddAssert(
                ...
                () =>
                    Precision.AlmostEquals(
                        colourPicker.SaturationValueControl.Value.Value,
                        value,
                        tolerance
                    )
            );
        ...
        private partial class TestHSVColourPicker : BasicHSVColourPicker
        {
            ...
            public SaturationValueSelector SaturationValueControl =>
                this.ChildrenOfType<SaturationValueSelector>().Single();
        }
    }
}
