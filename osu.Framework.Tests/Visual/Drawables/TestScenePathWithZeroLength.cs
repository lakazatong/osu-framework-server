...
namespace osu.Framework.Tests.Visual.Drawables
{
    public partial class TestScenePathWithZeroLength : GridTestScene
    {
            ...
            Cell(0)
                .AddRange(
                    new[]
                    {
                        ...
                        createPath(new[] { new Vector2(150f), new Vector2(150f) }),
                    }
                );
        ...
        private static Drawable createLabel(string text) =>
            new SpriteText
            {
                Text = text,
        ...
        private static Path createPath(Vector2[] points) =>
            new Path { PathRadius = 50, Vertices = points };
    }
}
