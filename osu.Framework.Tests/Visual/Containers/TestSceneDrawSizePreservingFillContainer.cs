...
namespace osu.Framework.Tests.Visual.Containers
{
    public partial class TestSceneDrawSizePreservingFillContainer : FrameworkTestScene
    {
        ...
        public void TestParentPadding()
        {
            ...
            AddStep(
                ...
                () =>
                {
                    Child = new Container
                    {
                        ...
                        Children = new Drawable[]
                        {
                            fullBox = new Box { RelativeSizeAxes = Axes.Both, Colour = Color4.Red },
                            new Container
                            {
                                RelativeSizeAxes = Axes.Both,
            ...
            AddAssert(
                "inner box stops at edge of right box",
                () =>
                    Precision.AlmostEquals(
                        fullBox.ScreenSpaceDrawQuad.TopRight,
                        innerBox.ScreenSpaceDrawQuad.TopRight
                    )
            );
        }
    }
