...
namespace osu.Framework.Extensions.ListExtensions
{
    public static class ListExtensions
    {
        ...
        /// <returns>The read-only view.</returns>
        public static SlimReadOnlyDictionaryWrapper<TKey, TValue> AsSlimReadOnly<TKey, TValue>(
            this Dictionary<TKey, TValue> dictionary
        )
            where TKey : notnull => new SlimReadOnlyDictionaryWrapper<TKey, TValue>(dictionary);
    }
}
