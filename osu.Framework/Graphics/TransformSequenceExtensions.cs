...
namespace osu.Framework.Graphics
{
    ...
    {
        public static TransformSequence<T> Expire<T>(
            this TransformSequence<T> t,
            bool calculateLifetimeStart = false
        )
            where T : Drawable => t.Append(o => o.Expire(calculateLifetimeStart));

        public static TransformSequence<T> Schedule<T, TData>(
            this TransformSequence<T> t,
            Action<TData> scheduledAction,
            TData data
        )
            where T : Drawable => t.Append(o => o.Schedule(scheduledAction, data));

        public static TransformSequence<T> Schedule<T>(
            this TransformSequence<T> t,
            Action scheduledAction
        )
            where T : Drawable => t.Append(o => o.Schedule(scheduledAction));

        public static TransformSequence<T> Schedule<T, TData>(
            this TransformSequence<T> t,
            Action<TData> scheduledAction,
            TData data,
            out ScheduledDelegate scheduledDelegate
        )
            where T : Drawable =>
        ...
        public static TransformSequence<T> Schedule<T>(
            ...
            where T : Drawable => t.Append(o => o.Schedule(scheduledAction), out scheduledDelegate);
        ...
        public static TransformSequence<T> Spin<T>(
            ...
            where T : Drawable =>
            t.Loop(d =>
                d.RotateTo(startRotation)
                    .RotateTo(
                        startRotation + (direction == RotationDirection.Clockwise ? 360 : -360),
                        revolutionDuration
                    )
            );
        ...
        public static TransformSequence<T> FadeIn<T>(
            ...
            where T : Drawable => t.FadeIn(duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> FadeInFromZero<T>(
            ...
            where T : Drawable => t.FadeInFromZero(duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> FadeOut<T>(
            ...
            where T : Drawable => t.FadeOut(duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> FadeOutFromOne<T>(
            ...
            where T : Drawable => t.FadeOutFromOne(duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> FadeTo<T>(
            ...
            where T : Drawable => t.FadeTo(newAlpha, duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> ScaleTo<T>(
            ...
            where T : Drawable => t.ScaleTo(newScale, duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> ResizeTo<T>(
            ...
            where T : Drawable => t.ResizeTo(newSize, duration, new DefaultEasingFunction(easing));
        ...
        public static TransformSequence<T> TransformRelativeChildOffsetTo<T>(
            ...
            where T : class, IContainer =>
            t.TransformRelativeChildOffsetTo(
                newOffset,
                duration,
        ...
        public static TransformSequence<T> FadeIn<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.FadeIn(duration, easing));
        ...
        public static TransformSequence<T> FadeInFromZero<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.FadeInFromZero(duration, easing));
        ...
        public static TransformSequence<T> FadeOut<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.FadeOut(duration, easing));
        ...
        public static TransformSequence<T> FadeOutFromOne<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.FadeOutFromOne(duration, easing));
        ...
        public static TransformSequence<T> FadeTo<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.FadeTo(newAlpha, duration, easing));
        ...
        public static TransformSequence<T> ScaleTo<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.ScaleTo(newScale, duration, easing));
        ...
        public static TransformSequence<T> ResizeTo<T, TEasing>(
            ...
            where T : Drawable
            where TEasing : IEasingFunction => t.Append(o => o.ResizeTo(newSize, duration, easing));
