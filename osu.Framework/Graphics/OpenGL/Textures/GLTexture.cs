    ...
    internal class GLTexture : INativeTexture
    {
        ...
        public int? MipLevel
        {
            ...
            set
            {
                ...
                GL.TexParameter(
                    ...
                    mipLevel ?? IRenderer.MAX_MIPMAP_LEVELS
                );
            }
        }
        ...
        protected virtual void DoUpload(ITextureUpload upload, IntPtr dataPointer)
        {
            ...
            if (textureId <= 0 || internalWidth != Width || internalHeight != Height)
            {
                ...
                if (textureId <= 0)
                {
                    ...
                    GL.TexParameter(
                        ...
                        (int)(
                            ...
                            : filteringMode == All.Linear ? All.LinearMipmapLinear
                            : All.Nearest
                        )
                    );
                    GL.TexParameter(
                ...
                if (
                    (Width == upload.Bounds.Width && Height == upload.Bounds.Height)
            ...
            else if (dataPointer != IntPtr.Zero)
            {
                ...
                GL.TexSubImage2D(
                    ...
                    upload.Bounds.X / div,
                    upload.Bounds.Y / div,
                    upload.Bounds.Width / div,
                    upload.Bounds.Height / div,
                    upload.Format,
                    PixelType.UnsignedByte,
                    dataPointer
                );
